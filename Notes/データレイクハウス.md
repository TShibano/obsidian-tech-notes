...
- [[SQL]] - レイクハウスの消費層で使用されるクエリ言語
- [[Apache Hadoop]] - レイクハウスの前身となった分散処理エコシステム
- [[Apache Arrow]] - レイクハウスエンジン間のインターオペラビリティ層
- [[Apache Hive]] - Hive Metastore がレイクハウスのカタログ基盤として利用される
- [[Apache Spark]] - レイクハウスの中核的な分散処理エンジン
- [[Delta Lake]] - Databricks 発のオープンソーステーブルフォーマット
- [[Snowflake]] - クラウドネイティブ DWH からレイクハウスへ拡張したプラットフォーム
- [[Databricks]] - レイクハウスアーキテクチャを体現する代表的なプラットフォーム
