...
- [[ポリグロット永続化]] — 複数の DB/NoSQL を使い分ける設計パターン
- [[ポリグロットデータストア]] — NoSQL を含む多様なデータストアの選定・組み合わせ方
- [[ドキュメントDB]] — JSON ドキュメントを柔軟なスキーマで格納する NoSQL
- [[KVストア]] — キーと値のペアで超高速アクセスを実現する NoSQL
- [[ワイドカラム型]] — 大量書き込みと水平スケールに特化した NoSQL
