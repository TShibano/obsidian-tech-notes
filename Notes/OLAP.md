...
キューブとはキューブ上に事前集計されたデータ構造のことであり，特定のディメンションによって，あらかじめ要約・グループ化されている．これにより効率的にデータを読み出すことができる．→ [[キューブ]]
...
- [[キューブ]] — OLAP の多次元データ構造．事前集計により高速なクエリを実現
- [[マルチディメンショナルモデル]] — スタースキーマ等のディメンショナルモデリング手法
- [[データアナリスト]] — OLAP を活用してビジネス分析を行う役割
- [[データサイエンティスト]] — OLAP 基盤のデータを ML/統計モデリングに活用する役割
- [[BigQuery]] — Google Cloud の OLAP 対応フルマネージドクラウド DWH
- [[Apache Druid]] — リアルタイム OLAP に特化した高性能分散データベース
